...
<section className="py-20 bg-white">
  <div className="container-custom">
    <div className="text-center mb-12">
      <h2 className="text-3xl md:text-4xl font-display font-bold">Historiska<span className="text-[#F0AE2C]"> reklamfavoriter</span> </h2>
      <p className="text-gray-700 text-base sm:text-lg">En tillbakablick på klassiska reklamfilmer från McDonald’s Sverige</p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      >
        ...
        <p className="mt-2 text-lg font-semibold text-center">McDonald's reklam – 1993</p>
      </a>
      ...
      >
        ...
        <p className="mt-2 text-lg font-semibold text-center">El Maco – 1999</p>
      </a>
      ...
      >
        ...
        <p className="mt-2 text-lg font-semibold text-center">Livet har sina goda stunder</p>
      </a>
    </div>
  </div>
</section>
