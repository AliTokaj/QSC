    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex space-x-6 xl:space-x-8 text-gray-800 font-medium">
          ...
          <a href="/ronald-mcdonald-barnfond" className="relative group px-2 py-1">
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-white/95 backdrop-blur-md shadow-lg mt-4 max-h-[80vh] overflow-y-auto">
          <nav className="flex flex-col space-y-4 p-6 text-gray-800 font-medium">
            ...
            <a href="/jobba-hos-oss" className="relative group py-2" onClick={closeMenu}>
              Jobba hos oss
              <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-yellow-500 transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="/ledningsgrupp" className="relative group py-2" onClick={closeMenu}>
              Ledningsgrupp
              <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-yellow-500 transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="/om-oss" className="relative group py-2" onClick={closeMenu}>
              Om oss
              <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-yellow-500 transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="/ronald-mcdonald-barnfond" className="relative group py-2" onClick={closeMenu}>
              Ronald McDonald Barnfond
              <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-yellow-500 transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="/kontakta-oss" className="relative group py-2" onClick={closeMenu}>
              Kontakta oss
              <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-yellow-500 transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a
